...
# ruby
dev-lang/ruby)                           echo "=$1-2.2.1";;
virtual/rubygems)                        echo "=$1-8";;
virtual/ruby-ssl)                        echo "=$1-5";;
...
# java
dev-java/oracle-jdk-bin)                 echo "=$1-1.7.0.76"
                                         echo "=$1-1.8.0.40";;
...
app-emulation/virtualbox*)               echo "=$1-4.3.24";;

dev-db/postgresql-*)                     echo "=$1-9.4.1";;
dev-libs/zziplib)                        echo "=$1-0.13.62";;
dev-vcs/bzr)                             echo "=$1-2.6.0";;
media-gfx/graphviz)                      echo "=$1-2.36.0";;
sys-apps/systemd)                        echo "=$1-219-r1";;
